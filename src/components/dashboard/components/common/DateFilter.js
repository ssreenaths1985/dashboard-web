...
class DateFilter extends Component {
  ...
  render() {
    if (this.state.showOne) {
      return (
        <div
          className="dateFilterTextColor"
          style={{ marginTop: "0.3em", display: "none" }}
        >
          {!this.state.showDateFilter && (
            <div className="row d-md-flex d-lg-flex">
              <div className="vl"></div>
              <div
                className="ms-3 me-4 customPadding cursorStyleOne"
          ...
          {this.state.showDateFilter && (
            <div className="row d-sm-flex d-md-flex d-lg-flex">
              ...
              <div
                className="ms-3 pr-4 d-sm-flex d-md-block d-lg-block d-xl-block customPadding cursorStyleOne"
                onClick={this.showFilter}
              >
                <h5 className="">{this.state.selectedFilter}</h5>
                <p className="">{this.state.selectedDate}</p>
            ...
            <div className="container" ref={this.container}>
              {!this.state.showCustomDateFilter && (
                <div className="dateDropDown">
                  <h6 className="ms-3 font-weight-bold mt-4">Presets</h6>
                  <div className="row ms-3 mb-1 customMargin mt-4">
                    <div className="">
                    ...
                    <div className="ml-5 ms-2 customMargin">
                  ...
                  <div className="row ms-3 customMargin">
                    <div className="">
                    ...
                    <div className="ms-4 customMargin">
                    ...
                    <div className="row moveRight col-md-9 ms-5 customMargin">
                      <Datepicker
                        pathName={this.props}
        ...
        <div className="mt-3">
          ...
          {this.state.showDateFilter && (
            <div className="btn-group custom-filter me-3">
              ...
              <div className="dropdown-menu custom-dropdown-menu"></div>
            </div>
          )}
          {this.state.showDateFilter && this.state.showDropDown && (
            <div className="container" ref={this.container}>
                  ...
                  <div className="row p-0">
                    <div className="col-sm-12 col-md-12 col-lg-12 col-xl-5 col-xxl-5 mb-3">
                      <div className="d-md-flex ms-4 mb-1 customMargin mt-2">
                        <div className="me-2">
                          <div className="">
                            {this.state.dateColumnOneHeader.map(
                              (dateFilter) => (
                                <p
                                  id="dateList"
                                  key={dateFilter.filter}
                          ...
                          <div className="customMargin">
                            {this.state.dateColumnTwoHeader.map(
                              (dateFilter) => (
                                <p
                                  id="dateList"
                                  key={dateFilter.filter}
