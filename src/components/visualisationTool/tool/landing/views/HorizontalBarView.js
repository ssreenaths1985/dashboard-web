...
const HorizontalBarView = ({
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      if (document.getElementById("legends-1")) {
        document.getElementById("legends-1").checked = true;
      }
    }, 500);
  ...
  const addColumn = (e) => {
    ...
    let colors = hbarPalette("cb-Custom1", data.length).map(function (hex) {
      return "#" + hex;
    });
  ...
  const updateLegends = (e) => {
    let value = document.getElementById("legends-1");

    showLegend(value.checked);
  };

  const updateGrids = (e) => {
    let value = document.getElementById("grid-1");
  ...
  return (
    <div className="col-12">
      ...
      {!isStacked && (
        <React.Fragment>
          <ul
            className="nav nav-tabs custom-nav-tabs-1"
            role="tablist"
            id="hBarTab"
          >
            <li className="nav-item me-2" role="presentation">
              <button
                ...
                id="dataHbar-tab"
                data-bs-toggle="tab"
                data-bs-target="#dataHbar"
                type="button"
                role="tab"
                aria-controls="dataHbar"
                aria-selected="true"
              >
                Data
              </button>
            ...
            <li className="nav-item" role="presentation">
              <button
                ...
                id="optionalHbar-tab"
                data-bs-toggle="tab"
                data-bs-target="#optionalHbar"
                type="button"
                role="tab"
                aria-controls="optionalHbar"
                aria-selected="false"
              >
                Configuration
              </button>
          ...
          <div className="tab-content" id="hBarTabContent">
            <div
              className="tab-pane fade show active"
              id="dataHbar"
              role="tabpanel"
              aria-labelledby="dataHbar-tab"
            >
                          ...
                          <React.Fragment key={j}>
                            <div className="">
                              ...
                              <div
                                ...
                                aria-labelledby="colorPickerDropdown"
                              >
                                <div className="">
                                  {colors.map((k, l) => {
                                    return (
            ...
            <div
              ...
              id="optionalHbar"
              role="tabpanel"
              aria-labelledby="optionalHbar-tab"
            >
      ...
      {isStacked && (
        <React.Fragment>
          ...
          >
            <li className="nav-item me-2" role="presentation">
              <button
                ...
                id="dataHSbar-tab"
                data-bs-toggle="tab"
                data-bs-target="#dataHSbar"
                type="button"
                role="tab"
                aria-controls="dataHSbar"
                aria-selected="true"
              >
                Data
              </button>
            ...
            <li className="nav-item" role="presentation">
              <button
                className="nav-link custom-tab-1 "
                id="optionalHSbar-tab"
                data-bs-toggle="tab"
                data-bs-target="#optionalHSbar"
                type="button"
                role="tab"
                aria-controls="optionalHSbar"
                aria-selected="false"
              >
                Configuration
              </button>
          ...
          <div className="tab-content" id="hSBarTabContent">
            <div
              className="tab-pane fade show active"
              id="dataHSbar"
              role="tabpanel"
              aria-labelledby="dataHSbar-tab"
            >
              <div className="p-0 m-0 mt-4 pt-2 hori-scroll-1 ps-4">
                {data &&
                  data.map((i, j) => {
                        ...
                        {j > 0 && (
                          <React.Fragment key={j}>
                            <div className="">
                              ...
                              <div
                                className="dropdown-menu color-picker-dd-1"
                                aria-labelledby="colorPickerDropdownHS"
                              >
                                <div className="">
                                  {colors.map((k, l) => {
                                    return (
            ...
            <div
              ...
              id="optionalHSbar"
              role="tabpanel"
              aria-labelledby="optionalHSbar-tab"
            >
              <div className="p-0 m-0 mt-4 pt-2">
                <div className="row">
                  <div className="col-6">
