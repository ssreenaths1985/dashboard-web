...
const AreaView = ({ passChartData, passHeaderData, showLegend, showGrid }) => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      if (document.getElementById("legends-5")) {
        document.getElementById("legends-5").checked = true;
      }
    }, 500);
  ...
  const addColumn = (e) => {
    ...
    let colors = areaPalette("cb-Custom1", data.length).map(function (hex) {
      return "#" + hex;
    });
  ...
  const updateLegends = (e) => {
    let value = document.getElementById("legends-5");

    showLegend(value.checked);
  };

  const updateGrids = (e) => {
    let value = document.getElementById("grid-5");
    ...
    <div className="col-12">
      ...
      >
        <li className="nav-item me-2" role="presentation">
          <button
            ...
            id="area-tab"
            data-bs-toggle="tab"
            data-bs-target="#dataArea"
            type="button"
            role="tab"
            aria-controls="dataArea"
            aria-selected="true"
          >
            Data
          </button>
        ...
        <li className="nav-item" role="presentation">
          <button
            ...
            id="optionalArea-tab"
            data-bs-toggle="tab"
            data-bs-target="#optionalArea"
            type="button"
            role="tab"
            aria-controls="optionalArea"
            aria-selected="false"
          >
            Configuration
          </button>
      ...
      <div className="tab-content" id="areaTabContent">
        ...
        <div
          ...
          id="optionalArea"
          role="tabpanel"
          aria-labelledby="optionalArea-tab"
        >
            ...
            <div className="mt-4">
              ...
              <div className="mt-3 ms-1">
                ...
                <label className="input-header-1 ms-3">
                  <span className="me-2">
                    <input type="checkbox" onClick={updateGrids} id="grid-5" />
                  </span>
                  Hide gridlines
                </label>
              </div>
