...
class FormAccess extends Component {
  constructor(props) {
    ...
    this.loadFormAccessDetails = this.loadFormAccessDetails.bind(this);
  }

  componentDidMount() {
    this.loadFormAccessDetails(this.props.match.params.id);
  }
  ...
  loadFormAccessDetails = formId => {
    FormService.find(formId).then(
      response => {
        if (response.statusInfo.statusCode === APP.CODE.SUCCESS) {
          this.setState({
            formAccessDetails: response.responseData
          });
        } else {
          ...
          <div className="col-md-12">
            <div className="row admin-pannel">
              ...
              <div className="col-md-10 admin-right-section">
                <FormTopPanel
                  form={this.state.formAccessDetails}
                    ...
                    <div className="form-group has-search">
                      <div className="row col-md-10 mb-4">
                        ...
                        <input
                          ...
                          autoComplete="off"
                          onKeyUp={event => this.searchFormItems(event)}
                        />
                      </div>
