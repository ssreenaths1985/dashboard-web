...
class DashboardLayout extends Component {
  constructor(props) {
    ...
    this.toggleVisColumns = this.toggleVisColumns.bind(this);
  }
  ...
  render() {
    ...
    return (
      <div
        className="col-sm-12 col-md-12 col-lg-12 col-xl-12 dashboardBG h-100 heightMin"
        id="dashboardLayout"
      >
        <div className="row">
          <BrandNavBar />
                  ...
                  <div className="col-md-6">
                    <div className="pull-right white-70 mr-5">
                      ...
                      <button
                        ...
                        onClick={event => this.toggleVisColumns(event)}
                      >
                ...
                <div className="row col-md-12 mt-4">
                  ...
                  >
                    <div className="row col-md-12 item-container">
                      <div className="col-md-8" id="visualizationOne">
                      ...
                      <div className="col-md-4" id="visualizationTwo">
                        <div className="dashboard-item bordered p-3">
                          <h6>
                            Visualization 2
                            <i className="material-icons pull-right">
                      ...
                      <div className="col-md-4" id="visualizationThree">
                        <div className="dashboard-item bordered p-3">
                          <h6>
                            Visualization 3
                            <i className="material-icons pull-right">
                      ...
                      <div className="col-md-4" id="visualizationFour">
                        <div className="dashboard-item bordered p-3">
                          <h6>
                            Visualization 4
                            <i className="material-icons pull-right">
                      ...
                      <div className="col-md-4" id="visualizationFive">
                        <div className="dashboard-item bordered p-3">
                          <h6>
                            Visualization 5
                            <i className="material-icons pull-right">
                      ...
                      <div className="col-md-12" id="visualizationSix">
                        <div className="dashboard-item bordered p-3">
                          <h6>
                            Visualization 6
                            <i className="material-icons pull-right">
