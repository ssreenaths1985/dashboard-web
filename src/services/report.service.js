...
function getData(code) {
  ...
  customUnitFilterLabel.push(
    localStorage.getItem("customFiltersConfigFirstFilter")
  );
  ...
  customCountryFilterLabel.push(
    localStorage.getItem("customFiltersConfigSecondFilter")
  );
  ...
  return fetch(
    window.env.REACT_APP_PMDASH_API_URL + APIS.MULTIPLEDASHBOARD.GETCHART,
    requestOptions
  ).then(handleResponse);
}
