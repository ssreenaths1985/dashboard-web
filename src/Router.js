...
const ReportsDashboard = loadable(() =>
  import("./components/dashboard/ReportsDashboard")
);
const ReportDetail = loadable(() =>
  import("./components/dashboard/ReportDetail")
);
const ToolLanding = loadable(() =>
  import("./components/dashboard/ToolLanding")
);
const ProtoTypeLanding = loadable(() =>
  import("./components/dashboard/ProtoTypeLanding")
);
const ProtoTypeHomeLanding = loadable(() =>
  import("./components/dashboard/ProtoTypeHomeLanding")
);
const SharePrototypeLanding = loadable(() =>
  import("./components/dashboard/SharePrototypeLanding")
);
...
const Router = (props) => (
  <BrowserRouter>
    <Switch>
      ...
      <PrivateRoute exact path="/reportDetail" component={ReportDetail} />
      <PrivateRoute
        exact
        path="/reportsDashboard"
        component={ReportsDashboard}
      />
      <PrivateRoute exact path="/tool" component={ToolLanding} />
      <PrivateRoute exact path="/creator" component={ProtoTypeLanding} />
      <PrivateRoute
        exact
        path="/prototypeHome"
        component={ProtoTypeHomeLanding}
      />
      <PrivateRoute
        exact
        path="/prototype/:id"
        component={SharePrototypeLanding}
      />
